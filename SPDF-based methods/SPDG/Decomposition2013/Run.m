...
% Description:
% ------------
% This file is the entry point for running the single-pool differential 
% grouping algorithm on the CEC'2013 benchmark functions.
...
for i = func
    ...
    [Subcomponents, FEs] = SPDG(fun, opts);
    Groups = cell(1,1);
    Seps = [];
    t = 1;
